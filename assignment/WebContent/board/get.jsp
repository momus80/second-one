				...
				<div class="panel-body">
					<form action=""  method="post" name="frm" class="frm-class">
						...
						<div class="form-group">
							...
							<textarea class="form-control" rows="20px" name="content"  id="content" style="height:500px;overflow:scroll;" readonly="readonly">
								<c:out value="${bno.content }" escapeXml="false"/>
							</textarea>
						</div>
