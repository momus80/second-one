	...
	<div>
		...
		<div class="w3-main w3-margin-bottom" style="margin-left: 340px; margin-right: 40px; width: 60%;">
			<div class="w3-center w3-text-white w3-round">
				...
				<c:if test="${section == 'FPS Board'}">
					<p>FPS 장르 게임들에 대한 이야기를 하는 게시판입니다</p>
				</c:if>
				<c:if test="${section == 'RTS Board'}">
					<p>RTS 장르 게임들에 대한 이야기를 하는 게시판입니다</p>
				</c:if>
				<c:if test="${section == 'Adventure Board'}">
					<p>어드벤처 장르 게임들에 대한 이야기를 하는 게시판입니다</p>
				</c:if>
				<c:if test="${section == 'Free Board'}">
					<p>자유로운 주제로 대화하는 게시판입니다</p>
				</c:if>
			</div>
			<div>
				<c:if test="${ id != null }">
